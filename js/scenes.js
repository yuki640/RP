export const scenes = [
  ...
  },
  {
    ...
    description:
      "Vous entrez dans une forêt dense et mystérieuse, où les ombres dansent autour de vous.",
    options: [
  ...
  },
  {
    ...
    description:
      "Vous découvrez une grotte dont l'entrée est gardée par une créature massive.",
    options: [{ texte: "Entrer dans la grotte", suivant: null }],
  },
  {
    id: 4,
    titre: "La forêt sombre",
